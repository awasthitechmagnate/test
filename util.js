...
const YoutubeNotifyQueue = require("../services/queues/YoutubeNotifyQueue");
...
router.post("/youtube_notify", async (req, res) => {
  ...
  try {
    ...
    await YoutubeNotifyQueue.add("YoutubeNotifyQueue", {
      payload: req.body,
      project_id: project_id
    });

    console.log(
      `⏱️ Youtube Postback enqueue: ${tEnqueue().toFixed(2)} ms`
    );
    console.log(
